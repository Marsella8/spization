...
@dataclass
class MDSeries:
    children: tuple[ModularDecompositionTree, ...] = field(default_factory=tuple)
...
@dataclass
class MDParallel:
    children: frozenset[ModularDecompositionTree] = field(
...
class MDPrime:
    ...
    def __iter__(self) -> Iterable[ModularDecompositionTree]:
